...
((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Hanoi' LIMIT 1),
 ...
 '2025-12-18 08:00:00', '2025-12-18 14:00:00', 500000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Hanoi' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51C-44444' LIMIT 1),
 '2025-12-18 10:00:00', '2025-12-18 16:00:00', 480000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Hanoi' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51A-12345' LIMIT 1),
 '2025-12-18 14:00:00', '2025-12-18 20:00:00', 520000, '{"refund": "12h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Hanoi' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51C-44444' LIMIT 1),
 '2025-12-18 18:00:00', '2025-12-19 00:00:00', 450000, '{"refund": "24h", "changes": "not_allowed"}', 'active'),

-- Hanoi to Ho Chi Minh City (reverse route - multiple trips)
((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Ho Chi Minh City' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30C-55555' LIMIT 1),
 '2025-12-19 06:00:00', '2025-12-19 12:00:00', 500000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Ho Chi Minh City' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51B-11111' LIMIT 1),
 '2025-12-19 08:00:00', '2025-12-19 14:00:00', 480000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Ho Chi Minh City' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30C-55555' LIMIT 1),
 '2025-12-19 12:00:00', '2025-12-19 18:00:00', 520000, '{"refund": "12h", "changes": "allowed"}', 'active'),

-- Ho Chi Minh City to Da Nang (popular route - multiple trips)
((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Da Nang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30A-67890' LIMIT 1),
 '2025-12-18 10:00:00', '2025-12-18 18:00:00', 350000, '{"refund": "12h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Da Nang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30B-22222' LIMIT 1),
 '2025-12-18 14:00:00', '2025-12-18 22:00:00', 320000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Da Nang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30A-67890' LIMIT 1),
 '2025-12-18 18:00:00', '2025-12-19 02:00:00', 380000, '{"refund": "12h", "changes": "not_allowed"}', 'active'),
...
((SELECT route_id FROM routes WHERE origin = 'Da Nang' AND destination = 'Ho Chi Minh City' LIMIT 1),
 ...
 '2025-12-19 08:00:00', '2025-12-19 16:00:00', 350000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Da Nang' AND destination = 'Ho Chi Minh City' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '29A-54321' LIMIT 1),
 '2025-12-19 12:00:00', '2025-12-19 20:00:00', 320000, '{"refund": "24h", "changes": "allowed"}', 'active'),

-- Hanoi to Da Nang
((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Da Nang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '29A-54321' LIMIT 1),
 '2025-12-19 06:00:00', '2025-12-19 12:00:00', 250000, '{"refund": "24h", "changes": "not_allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Da Nang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30B-22222' LIMIT 1),
 '2025-12-19 10:00:00', '2025-12-19 16:00:00', 280000, '{"refund": "12h", "changes": "allowed"}', 'active'),

-- Da Nang to Hanoi (reverse route)
((SELECT route_id FROM routes WHERE origin = 'Da Nang' AND destination = 'Hanoi' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51B-11111' LIMIT 1),
 '2025-12-20 08:00:00', '2025-12-20 14:00:00', 250000, '{"refund": "24h", "changes": "allowed"}', 'active'),

-- Other routes (single trips for now)
((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Hue' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '51B-11111' LIMIT 1),
 '2025-12-18 12:00:00', '2025-12-18 21:00:00', 400000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Sapa' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '29B-33333' LIMIT 1),
 '2025-12-19 07:00:00', '2025-12-19 13:00:00', 150000, '{"refund": "12h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Nha Trang' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30A-67890' LIMIT 1),
 '2025-12-18 16:00:00', '2025-12-18 20:00:00', 200000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Hanoi' AND destination = 'Hai Phong' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '29A-54321' LIMIT 1),
 '2025-12-19 09:00:00', '2025-12-19 10:30:00', 80000, '{"refund": "12h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Ho Chi Minh City' AND destination = 'Can Tho' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '29B-33333' LIMIT 1),
 '2025-12-18 20:00:00', '2025-12-18 21:30:00', 100000, '{"refund": "24h", "changes": "allowed"}', 'active'),

((SELECT route_id FROM routes WHERE origin = 'Da Nang' AND destination = 'Quang Ngai' LIMIT 1),
 (SELECT bus_id FROM buses WHERE license_plate = '30B-22222' LIMIT 1),
 '2025-12-19 14:00:00', '2025-12-19 15:00:00', 50000, '{"refund": "12h", "changes": "allowed"}', 'active')
ON CONFLICT DO NOTHING;
